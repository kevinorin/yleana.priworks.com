<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddPartnerOrg.aspx.cs" Inherits="YleanaAdmin.AddPartnerOrg" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<h1>Add Partner Organization</h1>	
	<br />
	<asp:Label ID="lblName" runat="server" Text="Name"></asp:Label>
	<br />
	<telerik:RadTextBox ID="txtName" runat="server" Width="600"></telerik:RadTextBox>
	<br />
	...
	<br />
	<br />
	<telerik:RadButton ID="btnAddOrg" ButtonType="StandardButton" runat="server" Text="Add" OnClick="btnAddOrg_Click"></telerik:RadButton>
	<br />
	<br />
