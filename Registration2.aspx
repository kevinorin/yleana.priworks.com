			...
			<div class="col-md-8 col-md-offset-3">
				...
				<div class="row spacedRow">
					...
					<div class="col-md-8">
						<asp:CheckBoxList ID="rbtStayHomeWith" runat="server" onchange="showStayHomeWithText();">
							<asp:ListItem Text="Both parents" Value="Both parents"></asp:ListItem>
							<asp:ListItem Text="Mother" Value="Mother"></asp:ListItem>
							<asp:ListItem Text="Father" Value="Father"></asp:ListItem>
							<asp:ListItem Text="Other Legal Guardian (that is not your mother/father)" Value="Other Legal Guardian (that is not your mother/father)"></asp:ListItem>
							<asp:ListItem Text="Siblings" Value="Siblings"></asp:ListItem>
							<asp:ListItem Text="Grandparent(s)" Value="Grandparent(s)"></asp:ListItem>
							<asp:ListItem Text="Aunt/Uncle" Value="Aunt/Uncle"></asp:ListItem>
							<asp:ListItem Text="Cousins" Value="Cousins"></asp:ListItem>
							<asp:ListItem Text="Step-parents" Value="Step-parents"></asp:ListItem>
							<asp:ListItem Text="Foster parents" Value="Foster parents"></asp:ListItem>
							<asp:ListItem Text="Step siblings" Value="Step siblings"></asp:ListItem>
							<asp:ListItem Text="Half siblings" Value="Half siblings"></asp:ListItem>
				...
				<div class="row spacedRow">
					...
					<div class="col-md-8">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtEmergencyContactName" ErrorMessage="Emergency Contact Name cannot be empty!"></asp:RequiredFieldValidator>
					</div>
				</div>
				...
				<div class="row spacedRow">
					...
					<div class="col-md-8">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="ddlRelation" ErrorMessage="Relationship cannot be empty!"></asp:RequiredFieldValidator>
					</div>
					<div id="divRelationText" style="display: none;">
						...
						<div class="col-md-8">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtRelationshipText" ErrorMessage="Other relationship cannot be empty!"></asp:RequiredFieldValidator>
						</div>
					</div>
				</div>
				<div class="row spacedRow">
					<div class="col-md-4">
						<label class="LabelInput"><span style="color: red;">*</span> What is a working cell phone/mobile number for us to contact this individual? </label>
					</div>
					<div class="col-md-8">
						<telerik:RadMaskedTextBox ID="txtparentContactNumber" runat="server" Mask="(###)###-####"></telerik:RadMaskedTextBox><br />
						<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtparentContactNumber" ErrorMessage="Parent/Guardian Contact Number cannot be empty!"></asp:RequiredFieldValidator>
                        <%--<asp:RegularExpressionValidator Display="Dynamic" ForeColor="Red" ID="MaskedTextBoxRegularExpressionValidator"
                                runat="server" ErrorMessage="Please format your cell phone number like this: (###)###-####" ControlToValidate="txtparentContactNumber"
				...
				<div class="row spacedRow">
					<div class="col-md-4">
						<label class="LabelInput"><span style="color: red;">*</span> Please provide a valid email address for this individual: </label>
					</div>
					<div class="col-md-8">
						<telerik:RadTextBox ID="txtParentEmail" runat="server" MaxLength="100"></telerik:RadTextBox><br />
						<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtParentEmail" ErrorMessage="Parent Contact Email cannot be empty!"></asp:RequiredFieldValidator>
				...
				<div class="row spacedRow">
					...
					<div class="col-md-8">
						<asp:CheckBoxList ID="cboIncomeContribution" runat="server" onchange="showIncomeContributionText();">
							...
							<asp:ListItem Text="One parent" Value="One parent"></asp:ListItem>
							<asp:ListItem Text="Both parents" Value="Both parents"></asp:ListItem>
							<asp:ListItem Text="Legal guardian" Value="Legal guardian"></asp:ListItem>
							<asp:ListItem Text="Siblings" Value="Siblings"></asp:ListItem>
							<asp:ListItem Text="Other" Value="Other"></asp:ListItem>
						</asp:CheckBoxList>
					</div>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-3">
				<div class="col-md-12">
					...
					<telerik:RadButton ID="btnSaveAndNext" runat="server" CausesValidation="false" ButtonType="StandardButton" Text="SAVE & NEXT" Width="30%" OnClick="btnSaveAndNext_Click"></telerik:RadButton>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-3">
						<div class="col-md-4">
							<label class="LabelInput">Step 2 of 5</label>
						</div>
					</div>
				</div>
			</div>
