...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
		...
		<div class="rspForms col-lg-12">
				...
				<div class="col-md-8 col-md-offset-3">
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtFirstName" ErrorMessage="First Name can not be empty!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtLastName" ErrorMessage="Last Name can not be empty!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
	                    ...
	                    <div id="divGenderText" style="display:none;">
						    <div class="col-md-4">
							    <label class="LabelInput">Fill your gender? </label>
						    </div>
						    <div class="col-md-8">
					...
					<div class="row spacedRow">
	                    ...
	                    <div id="divRaceText" style="display: none;">
	                        <div class="col-md-4">
	                            <label class="LabelInput">Fill your identify racially? </label>
	                        </div>
	                        <div class="col-md-8">
                    ...
                    <div class="row spacedRow">
						<div class="col-md-12">
							<label class="LabelInput"><span style="color: red;">*</span> We administer practice tests every Saturday morning while you are at camp. Is there any legitimate reason you would not be able to take a test on a Saturday? </label>
						</div>
						<div class="col-md-12">
					...
					<div class="row spacedRow">
	                    ...
	                    <div id="divCountryText" style="display: none;">
						    <div class="col-md-4">
							    <label class="LabelInput">Fill your Country : </label>
						    </div>
						    <div class="col-md-8">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-3">
                    <div id="divLangText" style="display: none;">
                        <div class="col-md-4">
                            <label class="LabelInput">Fill your Language : </label>
                        </div>
                        <div class="col-md-8">
					...
					<div class="col-md-4">
						<label><span style="color: red;">*</span> Contact Number(CellPhone) : </label>
					</div>
					<div class="col-md-8">
						<telerik:RadMaskedTextBox ID="txtPhoneMasked" runat="server" Mask="(###) ### - ####"></telerik:RadMaskedTextBox><br />
						<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtPhoneMasked" ErrorMessage="Contact Number can not be empty!"></asp:RequiredFieldValidator>
					</div>
					...
					<div class="col-md-8">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtEmail" ErrorMessage="Contact Email can not be empty!"></asp:RequiredFieldValidator>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-3">
					...
					<div class="col-md-6">
						<label><span style="color: red;">*</span> Do you have any conflicts that prevent you from attending either session? </label>
					</div>
					<div class="col-md-6">
    ...
    <div class="rspForms col-lg-12">
        <div class="row">
            <div class="col-md-8 col-md-offset-3">
                <div class="col-md-8 col-md-offset-3" style="padding-top: 30px !important;">
