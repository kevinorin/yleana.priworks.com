				...
				<div class="col-md-8 col-md-offset-3">
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="rboLiveInRoomYourSelf" ErrorMessage="Select the willing to live in a room by yourself options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="rboRoommateRequest" ErrorMessage="Select the roommate request options!"></asp:RequiredFieldValidator>
						</div>
						<div id="divRoommateRequestNameText" style="display: none;">
							...
							<div class="col-md-8">
								...
								<asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtRoommateRequestName" InitialValue="" ErrorMessage="Enter the roommate name!"></asp:RequiredFieldValidator>
							</div>
						</div>
					</div>
					...
					<div class="row spacedRow">
						<div class="col-md-4">
							<label><span style="color: red;">*</span> How do you keep your room at home? </label>
						</div>
						<div class="col-md-8">
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="rboMusicWhileStudy" ErrorMessage="Select the music while study options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							<telerik:RadTextBox ID="txtMusicType" runat="server" MaxLength="250" TextMode="MultiLine" Rows="5"></telerik:RadTextBox><br />
							<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtMusicType" ErrorMessage="Enter the music type while study options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							<telerik:RadTextBox ID="txtHobbies" runat="server" MaxLength="250" TextMode="MultiLine" Rows="5"></telerik:RadTextBox><br />
							<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtHobbies" ErrorMessage="Enter your favorite Hobbies options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							<telerik:RadTextBox ID="txtFavoriteMovies" runat="server" MaxLength="250" TextMode="MultiLine" Rows="5"></telerik:RadTextBox><br />
							<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtFavoriteMovies" ErrorMessage="Enter the favorite movies options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							<telerik:RadTextBox ID="txtLastBookRead" runat="server" MaxLength="250" TextMode="MultiLine" Rows="5"></telerik:RadTextBox><br />
							<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtLastBookRead" ErrorMessage="Enter the last three books you read options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							<telerik:RadTextBox ID="txtFavoriteBoardGame" runat="server" MaxLength="250" TextMode="MultiLine" Rows="5"></telerik:RadTextBox><br />
							<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtFavoriteBoardGame" ErrorMessage="Enter your favorite Board or card game options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							<telerik:RadTextBox ID="txtFavoriteSports" runat="server" MaxLength="250" TextMode="MultiLine" Rows="5"></telerik:RadTextBox><br />
							<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtFavoriteSports" ErrorMessage="Enter your favorite Sports options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="rboSleepWithLight" ErrorMessage="Select the Sleep with light options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="rboCanYouSleepWithLight" ErrorMessage="Select the Sleep with light options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="rboHeavySleeper" ErrorMessage="Select the Heavy Sleeper options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							<telerik:RadTextBox ID="txtSleeplingHabit" runat="server" MaxLength="250" TextMode="MultiLine" Width="75%" Rows="5"></telerik:RadTextBox><br />
							<asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtSleeplingHabit" ErrorMessage="Enter your Sleeping habits options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							<telerik:RadTextBox ID="txtAllergic" runat="server" MaxLength="250" TextMode="MultiLine" Width="75%" Rows="5"></telerik:RadTextBox><br />
							<asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtAllergic" ErrorMessage="Enter your allergic options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							<telerik:RadTextBox ID="txtReligiousFoodRestrictions" runat="server" MaxLength="250" TextMode="MultiLine" Width="75%" Rows="5"></telerik:RadTextBox><br />
							<asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtReligiousFoodRestrictions" ErrorMessage="Enter your religious restrictions options!"></asp:RequiredFieldValidator>
						</div>
					</div>
					...
					<div class="row spacedRow">
						...
						<div class="col-md-8">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="rboFastingDuringCamp" ErrorMessage="Select the reason for fasting during camp options!"></asp:RequiredFieldValidator>
						</div>
						<div id="divFastingDuringCampText" style="display: none;">
							...
							<div class="col-md-8">
								<telerik:RadTextBox ID="txtFastingDuringCamp" runat="server" MaxLength="50" TextMode="MultiLine" Width="75%" Rows="5"></telerik:RadTextBox>
								<asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtFastingDuringCamp" InitialValue="" ErrorMessage="Enter the fasting details!"></asp:RequiredFieldValidator>
							</div>
						</div>
						<div class="row spacedRow">
							<div class="col-md-4">
							...
							<div class="col-md-8">
								...
								<asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="rboFollowAnyDiet" ErrorMessage="Select the particular diet options!"></asp:RequiredFieldValidator>
							</div>
							...
							<div id="divOtherDietOptionText" style="display: none;">
								<div class="col-md-12">
									<telerik:RadTextBox ID="txtDietOptionText" runat="server" MaxLength="50" TextMode="MultiLine" Width="75%" Rows="5"></telerik:RadTextBox>
									<asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtDietOptionText" InitialValue="" ErrorMessage="Enter the other Diet details!"></asp:RequiredFieldValidator>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-3">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-3">
						<div class="col-md-4">
							<label class="LabelInput">Step 1 of 2</label>
						</div>
					</div>
				</div>
			</div>
